...
<script src="https://gist.github.com/Stagyrite/2175863894712ae71c129f7012d34da3.js"></script>

## Security issues

**Q: Are there any security issues with Perl 1?**

**A:** The [Perl 1](https://github.com/stagyrite/Perl-1.0 "Stagyrite/Perl-1.0: 🐪 Perl Kit, Version 1.0") interpreter is vulnerable to an attack that has to do with temporary files. Race conditions exist when a program is passed with 'e' command line option. Here's an example traditional Hello World program.
```
...
**Q: Can you explain your [Perl Harbor](https://gist.github.com/Stagyrite/2175863894712ae71c129f7012d34da3 "perl-harbor.c") exploit against Perl 1?**

**A:** There is a race condition when a user passes Perl code with the command line 'e' option. Here's a plan that Perl 1 implements:
